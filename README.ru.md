...
> **Статус проекта:** персональный системный компонент, опубликованный для
> изучения, адаптации и повторного использования. На авторской системе
> Arch/Hyprland он работает полноценно, но пока не является универсальной
> заменой настройкам любого дистрибутива.
